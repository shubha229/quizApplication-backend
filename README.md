...
This backend powers the frontend available here:  
https://github.com/shubha229/quiz_frontend

## 🚀 Features
- 📚 Fetch quiz questions by domain  
- 🔍 Get all available domains  
- 📝 Save quiz scores with username, domain, and total  
